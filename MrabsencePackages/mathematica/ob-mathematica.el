...
(defvar org-babel-mathematica-command "wolframscript -file"
  "Name of the command for executing Mathematica code.")

(defvar org-babel-mathematica-command-alt "math -noprompt"
  "Name of the command for executing Mathematica code.")

(defvar org-babel-mathematica-expand-body-prefix "SetOptions[$Output, FormatType -> OutputForm, CharacterEncoding -> \"UTF8\"];\n"
  "Add this Wolfram cmd before the babel code. It 1) adjust the output type.")

(defun org-babel-expand-body:mathematica (body params)
  "Expand BODY according to PARAMS, return the expanded body."
  (let ((vars (org-babel--get-vars params))
	(body-prefix org-babel-mathematica-expand-body-prefix))
    (concat
     body-prefix
...
called by `org-babel-execute-src-block'"
  (let* ((result-params (cdr (assoc :result-params params)))
   ...
   (cmd-postfix "-noprompt -print all")
   )
   ...
   (org-babel-script-escape (org-babel-trim raw))))
    (org-babel-eval (concat cmd " " tmp-script-file " " cmd-postfix) ""))))
